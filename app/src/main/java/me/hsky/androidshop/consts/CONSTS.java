package me.hsky.androidshop.consts;

/**
 * Created by Administrator on 2016/4/23.
 */
public class CONSTS {
    public static final String OnLineHost = "http://115.28.62.199/iData/iData_Json.ashx";
    public static final String HOST = "http://api.hsky.me/api/";

    public static final String City__Data_Url = HOST + "citys";
